        ...
        <style>
            ...
            @layer theme {
                ...
                :host {
                    ...
                    --color-emerald-50: oklch(.971 .013 17.38);
                    --color-emerald-100: oklch(.936 .032 17.717);
                    --color-emerald-200: oklch(.885 .062 18.334);
                    --color-emerald-300: oklch(.808 .114 19.571);
                    --color-emerald-400: oklch(.704 .191 22.216);
                    --color-emerald-500: oklch(.637 .237 25.331);
                    --color-emerald-600: oklch(.577 .245 27.325);
                    --color-emerald-700: oklch(.505 .213 27.518);
                    --color-emerald-800: oklch(.444 .177 26.899);
                    --color-emerald-900: oklch(.396 .141 25.723);
                    --color-emerald-950: oklch(.258 .092 26.042);
                    ...
                    --color-emerald-50: oklch(.986 .031 120.757);
                    --color-emerald-100: oklch(.967 .067 122.328);
                    --color-emerald-200: oklch(.938 .127 124.321);
                    --color-emerald-300: oklch(.897 .196 126.665);
                    --color-emerald-400: oklch(.841 .238 128.85);
                    --color-emerald-500: oklch(.768 .233 130.85);
                    --color-emerald-600: oklch(.648 .2 131.684);
                    --color-emerald-700: oklch(.532 .157 131.589);
                    --color-emerald-800: oklch(.453 .124 130.933);
                    --color-emerald-900: oklch(.405 .101 131.063);
                    --color-emerald-950: oklch(.274 .072 132.109);
                    --color-emerald-50: oklch(.982 .018 155.826);
                    --color-emerald-100: oklch(.962 .044 156.743);
                    --color-emerald-200: oklch(.925 .084 155.995);
                    --color-emerald-300: oklch(.871 .15 154.449);
                    --color-emerald-400: oklch(.792 .209 151.711);
                    --color-emerald-500: oklch(.723 .219 149.579);
                    --color-emerald-600: oklch(.627 .194 149.214);
                    --color-emerald-700: oklch(.527 .154 150.069);
                    --color-emerald-800: oklch(.448 .119 151.328);
                    --color-emerald-900: oklch(.393 .095 152.535);
                    --color-emerald-950: oklch(.266 .065 152.934);
                    ...
                    --color-emerald-50: oklch(.962 .018 272.314);
                    --color-emerald-100: oklch(.93 .034 272.788);
                    --color-emerald-200: oklch(.87 .065 274.039);
                    --color-emerald-300: oklch(.785 .115 274.713);
                    --color-emerald-400: oklch(.673 .182 276.935);
                    --color-emerald-500: oklch(.585 .233 277.117);
                    --color-emerald-600: oklch(.511 .262 276.966);
                    --color-emerald-700: oklch(.457 .24 277.023);
                    --color-emerald-800: oklch(.398 .195 277.366);
                    --color-emerald-900: oklch(.359 .144 278.697);
                    --color-emerald-950: oklch(.257 .09 281.288);
