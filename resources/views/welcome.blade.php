        ...
        <style>
            ...
            @layer theme {
                ...
                :host {
                    ...
                    --color-purple-50: oklch(.971 .013 17.38);
                    --color-purple-100: oklch(.936 .032 17.717);
                    --color-purple-200: oklch(.885 .062 18.334);
                    --color-purple-300: oklch(.808 .114 19.571);
                    --color-purple-400: oklch(.704 .191 22.216);
                    --color-purple-500: oklch(.637 .237 25.331);
                    --color-purple-600: oklch(.577 .245 27.325);
                    --color-purple-700: oklch(.505 .213 27.518);
                    --color-purple-800: oklch(.444 .177 26.899);
                    --color-purple-900: oklch(.396 .141 25.723);
                    --color-purple-950: oklch(.258 .092 26.042);
                    ...
                    --color-purple-50: oklch(.986 .031 120.757);
                    --color-purple-100: oklch(.967 .067 122.328);
                    --color-purple-200: oklch(.938 .127 124.321);
                    --color-purple-300: oklch(.897 .196 126.665);
                    --color-purple-400: oklch(.841 .238 128.85);
                    --color-purple-500: oklch(.768 .233 130.85);
                    --color-purple-600: oklch(.648 .2 131.684);
                    --color-purple-700: oklch(.532 .157 131.589);
                    --color-purple-800: oklch(.453 .124 130.933);
                    --color-purple-900: oklch(.405 .101 131.063);
                    --color-purple-950: oklch(.274 .072 132.109);
                    --color-purple-50: oklch(.982 .018 155.826);
                    --color-purple-100: oklch(.962 .044 156.743);
                    --color-purple-200: oklch(.925 .084 155.995);
                    --color-purple-300: oklch(.871 .15 154.449);
                    --color-purple-400: oklch(.792 .209 151.711);
                    --color-purple-500: oklch(.723 .219 149.579);
                    --color-purple-600: oklch(.627 .194 149.214);
                    --color-purple-700: oklch(.527 .154 150.069);
                    --color-purple-800: oklch(.448 .119 151.328);
                    --color-purple-900: oklch(.393 .095 152.535);
                    --color-purple-950: oklch(.266 .065 152.934);
