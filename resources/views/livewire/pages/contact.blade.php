                ...
                <div class="relative px-8 sm:px-12 py-12">
                    ...
                    <dl class="space-y-6 mt-10 text-gray-500 text-base">
                        <div class="flex gap-3">
                            ...
                            <dd><a class="text-emerald-600 hover:text-emerald-800" href="mailto:{{ App\Models\Setting::get('email') ?? 'contact@votresite.com' }}">{{ App\Models\Setting::get('email') ?? 'contact@votresite.com' }}</a></dd>
                        </div>
                        <div class="flex gap-3">
                            <dt class="flex-shrink-0">
                            ...
                            <dd><a class="text-emerald-600 hover:text-emerald-800" href="https://wa.me/{{ App\Models\Setting::get('contact_phone') ?? '33612345678' }}" target="_blank" rel="noopener">{{ App\Models\Setting::get('contact_phone') ?? '+33 6 12 34 56 78' }} (WhatsApp)</a></dd>
                        </div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <dd><a class="text-emerald-600 hover:text-emerald-800" href="{{ App\Models\Setting::get('insta_link') }}" target="_blank" rel="noopener">Instagram</a></dd>
                        </div>
                        @endif
                    </dl>
                </div>
                ...
                <div class="px-8 sm:px-12 py-12 lg:border-gray-200 lg:border-l">
                    ...
                    <form wire:submit="submit" class="space-y-6 mt-8">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" id="name" wire:model="name" class="block shadow-sm px-4 py-3 border-gray-300 focus:border-emerald-500 rounded-md focus:ring-emerald-500 w-full placeholder-gray-400" placeholder="Nom complet*" required>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="email" id="email" wire:model="email" class="block shadow-sm px-4 py-3 border-gray-300 focus:border-emerald-500 rounded-md focus:ring-emerald-500 w-full placeholder-gray-400" placeholder="Adresse e-mail*" required>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <textarea id="message" wire:model="message" rows="4" class="block shadow-sm px-4 py-3 border-gray-300 focus:border-emerald-500 rounded-md focus:ring-emerald-500 w-full placeholder-gray-400" placeholder="Votre message*" required></textarea>
                        ...
                        <div>
                            <button type="submit"
                                class="flex justify-center bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 shadow-sm px-4 py-3 border border-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 w-full font-medium text-white text-base">
