        ...
        <div x-show="show"
            ...
            <form wire:submit.prevent="save">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" wire:model="name" id="name"
                                class="block bg-gray-800 shadow-sm mt-1 border-gray-700 focus:border-emerald-500 rounded-md focus:ring-emerald-500 w-full text-white sm:text-sm">
                            @error('name')
                        ...
                        <div>
                            ...
                            <textarea wire:model="description" id="description" rows="3"
                                class="block bg-gray-800 shadow-sm mt-1 border-gray-700 focus:border-emerald-500 rounded-md focus:ring-emerald-500 w-full text-white sm:text-sm"></textarea>
                            @error('description')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="file" wire:model="image" id="image"
                                class="block hover:file:bg-emerald-100 file:bg-emerald-50 mt-1 file:mr-4 file:px-4 file:py-2 file:border-0 file:rounded-md w-full file:font-semibold text-gray-300 file:text-emerald-700 text-sm file:text-sm">
                            @error('image')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" wire:model="is_active" id="is_active"
                                class="bg-gray-800 border-gray-700 rounded focus:ring-emerald-500 w-4 h-4 text-emerald-600">
                ...
                <div class="sm:flex sm:flex-row-reverse bg-gray-800 px-4 sm:px-6 py-3">
                    <button type="submit"
                        class="inline-flex justify-center bg-emerald-600 hover:bg-emerald-700 shadow-sm sm:ml-3 px-4 py-2 border border-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 w-full sm:w-auto font-medium text-white sm:text-sm text-base">
                        {{ $editMode ? 'Mettre à jour' : 'Créer' }}
                    </button>
                    <button type="button" wire:click="closeModal"
                        class="inline-flex justify-center bg-gray-800 hover:bg-gray-700 shadow-sm mt-3 sm:mt-0 sm:ml-3 px-4 py-2 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 w-full sm:w-auto font-medium text-gray-300 sm:text-sm text-base">
                        Annuler
                    </button>
                </div>
            </form>
